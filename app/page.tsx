          ...
          <div>
            ...
            <Reveal delay={0.2}>
              <div className="mt-10 grid gap-8 text-lg leading-8 text-slate-400 md:grid-cols-2">
                <p>
                  Yönetim Bilişim Sistemleri alanında eğitim alırken web geliştirme,
                  nesne yönelimli programlama, veritabanı sistemleri ve yazılım
                  teknolojileri üzerine çalışmalar yapıyorum.
                </p>
              ...
              <div className="relative">
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-3">
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <p className="font-medium text-white">Teknik destek süreçleri</p>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <p className="font-medium text-white">Sistem ve altyapı</p>
                    <p className="mt-2 text-sm leading-6 text-slate-500">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    <p className="font-medium text-white">Kurumsal BT deneyimi</p>
                    <p className="mt-2 text-sm leading-6 text-slate-500">
          ...
          <div className="flex flex-col gap-8 border-t border-white/10 pt-8 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-5 max-w-md text-sm leading-6 text-slate-500">
                Web geliştirme, yazılım projeleri ve veritabanı teknolojileri
                üzerine çalışan; modern ve kullanıcı odaklı dijital çözümler
